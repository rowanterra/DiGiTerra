...
def train_hist_gradient_boosting_classifier(train_data, target_variables, use_stratified_split,
    ...
    model = HistGradientBoostingClassifier(loss=kwargs.get('loss', 'log_loss'),
