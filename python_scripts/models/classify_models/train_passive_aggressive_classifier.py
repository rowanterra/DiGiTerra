...
def train_passive_aggressive_classifier(train_data, target_variables, use_stratified_split,
    ...
    model = MultiOutputClassifier(PassiveAggressiveClassifier(C=kwargs.get('C', 1.0),
