...
def train_lassolars_cv(model_type, train_data, target_variables, use_stratified_split,
    ...
    model = LassoLarsCV(fit_intercept=kwargs.get('fit_intercept', True),
                       verbose=kwargs.get('verbose', False),
                       max_iter=kwargs.get('max_iter', 500),
                       precompute=kwargs.get('precompute', 'auto'),
                       cv=kwargs.get('cv', None),
                       max_n_alphas=kwargs.get('max_n_alphas', 1000),
