...
def train_theilsen_regressor(model_type, train_data, target_variables, use_stratified_split,
    ...
    model = TheilSenRegressor(fit_intercept=kwargs.get('fit_intercept', True),
                              max_subpopulation=kwargs.get('max_subpopulation', 10000),
                              n_subsamples=kwargs.get('n_subsamples', None),
