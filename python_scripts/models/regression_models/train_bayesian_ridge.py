...
def train_bayesian_ridge(model_type, train_data, target_variables, use_stratified_split,
    ...
    model = BayesianRidge(max_iter=kwargs.get('max_iter', kwargs.get('n_iter', 300)),
                         ...
                         alpha_init=kwargs.get('alpha_init', None),
